...
Next.js, TypeScript, Tailwind CSS, and shadcn/ui. Body type is Poppins. Headings use self-hosted Dharma Gothic E Extra Bold Italic. Brand colors are navy `#083677`, green `#247360`, red `#b8283f`, and white.
