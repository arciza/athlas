...
export default async function TravelPage({
  ...
  return (
    <>
        ...
        action={
          <a
            ...
            className={cn(
              ...
              "h-12 px-6 text-base font-semibold bg-[#247360] text-white hover:bg-[#247360]/90"
            )}
          >
            {copy.travel.bookNow}
          </a>
      ...
      <section id="travel-contact" className="scroll-mt-20 bg-[#083677] py-16 text-white">
        <div className="mx-auto grid max-w-6xl gap-10 px-4 sm:px-6 lg:grid-cols-2">
          <div>
            ...
            <a
              ...
              className={cn(
                buttonVariants({ size: "lg" }),
                "mt-8 h-12 px-6 text-base font-semibold bg-[#247360] text-white hover:bg-[#247360]/90"
              )}
            >
              {copy.travel.inquireCta}
            </a>
          </div>
          <div className="rounded-2xl bg-white p-6 text-[#083677] ring-1 ring-white/10">
